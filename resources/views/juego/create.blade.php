...
@section('include')
<div class="container">
  <form method="post" action="{{url('juego')}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" min="0" class="form-control form-control-lg" id="lvFormGroupInput" placeholder="descripcion" name="description">
        </div>
    </div>
    <!--<div class="form-group row">
